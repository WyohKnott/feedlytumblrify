    ...
    return {
        ...
        getPrefs: function (prefs) {
            return new Promise(function (resolve, reject) {
                chrome.runtime.sendMessage({getPrefs: prefs}, function(response) {
                    console.log('runtime sendMessage get', response);
                    resolve(response);
                });
            });
        },
        ...
        setPrefs: function (prefs) {
            return new Promise(function (resolve, reject) {
                chrome.runtime.sendMessage({setPrefs: prefs}, function(response) {
                    console.log('runtime sendMessage set', response);
                    resolve(response);
                });
            });
        },
